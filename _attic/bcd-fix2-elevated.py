#!/usr/bin/env python3
"""BCD 诊断+加固提权驱动：跑 bcd-fix2.ps1（先补 BOM），轮询至 BCD2 DONE。"""
import ctypes
import os
import sys
import time
