#!/usr/bin/env python3
"""BCD fix3 提权驱动：跑 bcd-fix3.ps1（先补 BOM），轮询至 BCD3 DONE。"""
import ctypes
import os
import sys
import time
