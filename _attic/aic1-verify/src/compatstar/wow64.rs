...
pub fn run_wow64_checks() -> CheckSet {
    CheckSet::merge(run_wow64_base_checks(), CheckSet::merge(run_wow64_deep_checks(), CheckSet::merge(run_wow64_deep2_checks(), CheckSet::merge(run_wow64_deep3_checks(), CheckSet::merge(run_wow64_deep4_checks(), CheckSet::merge(run_wow64_deep5_checks(), run_wow64_deep6_checks()))))))
}
