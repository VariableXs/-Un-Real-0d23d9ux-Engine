...
pub fn run_dragdrop_checks() -> CheckSet {
    CheckSet::merge(run_dragdrop_base_checks(), CheckSet::merge(run_dragdrop_deep_checks(), CheckSet::merge(run_dragdrop_deep2_checks(), CheckSet::merge(run_dragdrop_deep3_checks(), CheckSet::merge(run_dragdrop_deep4_checks(), run_dragdrop_deep5_checks())))))
}
