...
pub fn run_peblend_checks() -> CheckSet {
    CheckSet::merge(run_peblend_base_checks(), CheckSet::merge(run_peblend_deep_checks(), CheckSet::merge(run_peblend_deep2_checks(), CheckSet::merge(run_peblend_deep3_checks(), CheckSet::merge(run_peblend_deep4_checks(), run_peblend_deep5_checks())))))
}
