...
pub fn run_lnkfile_checks() -> CheckSet {
    CheckSet::merge(run_lnkfile_base_checks(), CheckSet::merge(run_lnkfile_deep_checks(), CheckSet::merge(run_lnkfile_deep2_checks(), CheckSet::merge(run_lnkfile_deep3_checks(), CheckSet::merge(run_lnkfile_deep4_checks(), CheckSet::merge(run_lnkfile_deep5_checks(), CheckSet::merge(run_lnkfile_deep6_checks(), run_lnkfile_deep8_checks())))))))
}
