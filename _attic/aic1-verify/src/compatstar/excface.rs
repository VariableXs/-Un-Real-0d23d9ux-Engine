...
pub fn run_excface_checks() -> CheckSet {
    CheckSet::merge(run_excface_base_checks(), CheckSet::merge(run_excface_deep_checks(), CheckSet::merge(run_excface_deep2_checks(), CheckSet::merge(run_excface_deep3_checks(), CheckSet::merge(run_excface_deep4_checks(), run_excface_deep5_checks())))))
}
