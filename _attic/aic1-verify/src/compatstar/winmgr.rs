...
pub fn run_winmgr_checks() -> CheckSet {
    CheckSet::merge(run_winmgr_base_checks(), CheckSet::merge(run_winmgr_deep_checks(), CheckSet::merge(run_winmgr_deep2_checks(), CheckSet::merge(run_winmgr_deep3_checks(), run_winmgr_deep4_checks()))))
}
