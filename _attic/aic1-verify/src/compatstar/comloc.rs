...
pub fn run_comloc_checks() -> CheckSet {
    CheckSet::merge(run_comloc_base_checks(), CheckSet::merge(run_comloc_deep_checks(), CheckSet::merge(run_comloc_deep2_checks(), CheckSet::merge(run_comloc_deep3_checks(), CheckSet::merge(run_comloc_deep4_checks(), CheckSet::merge(run_comloc_deep5_checks(), run_comloc_deep6_checks()))))))
}
