...
pub fn run_comdlg_checks() -> CheckSet {
    CheckSet::merge(run_comdlg_base_checks(), CheckSet::merge(run_comdlg_deep_checks(), CheckSet::merge(run_comdlg_deep2_checks(), CheckSet::merge(run_comdlg_deep3_checks(), run_comdlg_deep4_checks()))))
}
