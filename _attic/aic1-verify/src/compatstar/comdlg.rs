...
pub fn run_comdlg_checks() -> CheckSet {
    CheckSet::merge(run_comdlg_base_checks(), CheckSet::merge(run_comdlg_deep_checks(), CheckSet::merge(run_comdlg_deep2_checks(), CheckSet::merge(run_comdlg_deep3_checks(), CheckSet::merge(run_comdlg_deep4_checks(), CheckSet::merge(run_comdlg_deep5_checks(), CheckSet::merge(run_comdlg_deep6_checks(), run_comdlg_deep7_checks())))))))
}
