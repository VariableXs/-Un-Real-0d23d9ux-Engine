...
pub fn run_fsredir_checks() -> CheckSet {
    CheckSet::merge(run_fsredir_base_checks(), CheckSet::merge(run_fsredir_deep_checks(), CheckSet::merge(run_fsredir_deep2_checks(), CheckSet::merge(run_fsredir_deep3_checks(), CheckSet::merge(run_fsredir_deep4_checks(), CheckSet::merge(run_fsredir_deep5_checks(), CheckSet::merge(run_fsredir_deep6_checks(), run_fsredir_deep7_checks())))))))
}
