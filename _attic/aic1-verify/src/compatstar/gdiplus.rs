...
pub fn run_gdiplus_checks() -> CheckSet {
    CheckSet::merge(run_gdiplus_base_checks(), CheckSet::merge(run_gdiplus_deep_checks(), CheckSet::merge(run_gdiplus_deep2_checks(), CheckSet::merge(run_gdiplus_deep3_checks(), CheckSet::merge(run_gdiplus_deep4_checks(), run_gdiplus_deep5_checks())))))
}
