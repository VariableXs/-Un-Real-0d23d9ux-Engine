...
pub fn run_persrc_checks() -> CheckSet {
    CheckSet::merge(run_persrc_base_checks(), CheckSet::merge(run_persrc_deep_checks(), CheckSet::merge(run_persrc_deep2_checks(), CheckSet::merge(run_persrc_deep3_checks(), CheckSet::merge(run_persrc_deep4_checks(), run_persrc_deep5_checks())))))
}
