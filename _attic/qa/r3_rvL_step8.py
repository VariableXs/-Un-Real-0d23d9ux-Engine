# R3-B1 step8: AttachThreadInput to fg thread -> SetForegroundWindow(steam) -> SendInput
import ctypes, time
...
tid_fg = u32.GetWindowThreadProcessId(u32.GetForegroundWindow(), None)
tid_steam = u32.GetWindowThreadProcessId(HWND, None)
tid_me = k32.GetCurrentThreadId()
a1 = u32.AttachThreadInput(tid_me, tid_fg, True)
a2 = u32.AttachThreadInput(tid_me, tid_steam, True)
u32.BringWindowToTop(HWND)
u32.SetForegroundWindow(HWND); time.sleep(0.6)
print("attach:", a1, a2, "fg now:", u32.GetForegroundWindow(), "expect", HWND, flush=True)
...
u32.SetForegroundWindow(HWND_VAR); time.sleep(1.4)
s("rv_L1_fg_trick_ABC")
