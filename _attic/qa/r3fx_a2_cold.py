# R3-B11 fix test A2 (cold start): double-click desktop Steam icon -> poll screenshots + log delta
...
# cold start: double-click desktop Steam icon
...
cur = log_snapshot()
delta = cur[mark:]
print("=== LOG DELTA (cold) ===", flush=True)
