# R3-B4 step11: click correct red close (1741,120), then search 设置
import ctypes, time
...
pyautogui.click(1741, 120); time.sleep(2.0)     # red close of vwm
s("rv_P1_detached2")
pyautogui.click(759, 1041); time.sleep(1.8)     # start menu
s("rv_P2_menu_open")
pyautogui.click(959, 97); time.sleep(1.0)       # search box
set_clipboard("设置")
pyautogui.hotkey("ctrl", "v"); time.sleep(1.8)
s("rv_P3_search_results")
print("step11 done", flush=True)
