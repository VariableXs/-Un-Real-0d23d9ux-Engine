...
> 功能定义见 `NEXT-40-功能全景.md`；每批施工八步法与回滚见 `NEXT-40-实施步骤.md`。
> 总则继承 [AI五路分工计划.md](AI五路分工计划.md) 第 0 节（批次自检十步/防 BUG 十二条/优化五军规/IPC 契约/冲突裁决），本文只写增量。
...
*阅读顺序：先 `NEXT-40-功能全景.md`（做什么）→ 再 `NEXT-40-实施步骤.md`（怎么做）→ 本文档（谁与何时）。*
...
**版本**：`1.1ascent.vxe`
**姊妹篇**：`ASCENT-60-功能全景.md`（做什么）、`ASCENT-60-实施步骤.md`（怎么做）。
