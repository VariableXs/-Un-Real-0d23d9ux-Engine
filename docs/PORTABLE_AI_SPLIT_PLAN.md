...
## AI-1 存储核 详细计划（对应主计划 第3章 + 第9章 + 扩充13/20/26） <sub>✅ 已实施</sub>
...
# 下一阶段 v2 6大件 多AI分工（新增 40000字计划）

> 基于 `docs/PORTABLE_PHASE2_PLAN.md` 40000字，按 `docs/PORTABLE_VIRTUAL_SYSTEM_PLAN.md` v1地基，6大件实现真·极致

## v2 分工总览

| AI | 代号 | v2负责章节 | 详细内容 | 独立目录 | 状态 |
|---|---|---|---|---|---|
| AI-1 | 内核隔离2.0 | 第1+8章 MicroVM+独立10层 | Hyper-V隔离容器/HvSocket/层8-10 VBS/SBOM | `portable/AI1/` | ⬜ 待实施 |
| AI-2 | 万能开2.0 | 第2+9章 全格式 | UWP/MSIX/PWA/WSL/Docker/Flatpak/Wine | `portable/AI2/` | ⬜ 待实施 |
| AI-3 | 插件市场 | 第3章 市场+SDK | 轻市场market.json + IPluginHost + 兼容VSCode/Chrome | `portable/AI3/` | ⬜ 待实施 |
| AI-4 | 云同步 | 第4章 云盘 | rclone增量加密 + 10分钟恢复 + 版本 | `portable/AI4/` | ⬜ 待实施 |
| AI-5 | 企业安全 | 第5章 安全 | 沙箱+0day隔离网+离线杀毒 | `portable/AI5/` | ⬜ 待实施 |
| AI-6 | 跨平台 | 第6章 跨平台 | Mac UTM/QEMU + Linux KVM + virtiofs | `portable/AI6/` | ⬜ 待实施 |

> 拓宽：AI-1兼第7章AI/硬件拓展，AI-2兼第9章更多格式，AI-3兼主题拓展

### v2 详细任务（按主计划逐项）

#### AI-1 内核隔离2.0 <sub>⬜ 待实施</sub>
- [ ] MicroVM `New-VM -EnableVBS` 每App一VM
- [ ] 层8 HVCI/层9 Secure Boot/层10 SBOM
- 输出 `portable/AI1/MicroVM.ps1` + `AI1-隔离2.0.md` 6000字

#### AI-2 万能开2.0 <sub>⬜ 待实施</sub>
- [ ] UWP `IApplicationActivationManager` + MSIX `Mount-AppxVolume` + PWA WebView2 + WSLg
- [ ] Docker/Flatpak/Wine 云应用
- 输出 `portable/AI2/UniversalOpen.ps1` + `AI2-万能开2.0.md` 6000字

#### AI-3 插件市场 <sub>⬜ 待实施</sub>
- [ ] market.json GitHub Releases + IPluginHost SDK + VSCode/Chrome兼容
- 输出 `portable/AI3/Market.ps1` + `AI3-市场.md` 5000字

#### AI-4 云同步 <sub>⬜ 待实施</sub>
- [ ] rclone crypt 7天版本 + 丢盘恢复
- 输出 `portable/AI4/Sync.ps1` + `AI4-云同步.md` 5000字

#### AI-5 安全 <sub>⬜ 待实施</sub>
- [ ] Sandbox审Exchange + 隔离网
- 输出 `AI5-安全.md` 5000字

#### AI-6 跨平台 <sub>⬜ 待实施</sub>
- [ ] UTM/QEMU + KVM，1TB盘任意电脑
- 输出 `AI6-跨平台.md` 5000字

**并行：** AI1-6可并行，每AI独立分支 `portable/ai-v2-*`，完成后在主计划和本表右侧框打✅。
