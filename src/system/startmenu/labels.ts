...
export const START_LABELS = {
  zh: {
    ...
    boardMore: "更多操作",
    boardStat: "本机累计启动",
    boardNoRecent: "还没有最近使用记录",
    boardSearchHint: "点一下填入搜索框",
  },
  en: {
    ...
    // Win11-style board (three columns: recent / today / info cards)
    boardHero: "Image of the day",
    boardHeroEmpty: "Local wallpaper",
    boardTopApps: "Top apps",
    boardQuiz: "Daily Quiz",
    boardTip: "Tip of the day",
    boardTrending: "Trending searches",
    boardQuizRight: "Correct",
    boardQuizWrong: "Not quite",
    boardMore: "More",
    boardStat: "Total launches",
    boardNoRecent: "No recent items yet",
    boardSearchHint: "Click to fill the search box",
  },
};
