...
export function checkF0262(): CheckEntry[] {
  ...
  return [
    ...
    { id: 'F06541', name: 'Matrix 位', check: () => !(C.ALLIANCE_PROTOCOLS as readonly string[]).includes('Matrix') },
    { id: 'F06542', name: 'AP 位', check: () => !(C.ALLIANCE_PROTOCOLS as readonly string[]).includes('ActivityPub') },
