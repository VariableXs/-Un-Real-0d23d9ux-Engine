...
export function checkF0281(): CheckEntry[] {
  ...
  return [
    ...
    { id: 'X07008', name: '显示·中断还原', check: () => { const q = new T.DisplayPipeline('eco'); return q.brightnessWith(-70) === 0 && q.brightnessWith(30) === 20; } },
    ...
    { id: 'X07013', name: '显示·键盘序', check: () => (T.DISPLAY_MODES as string[]).includes('creator') && new T.DisplayPipeline('creator').profileId === 'creator' },
    ...
    { id: 'X07021', name: '显示·智能建议', check: () => d.pushLayer('hdr') === 1 && d.layers[0] === 'hdr' },
...
export function checkF0283(): CheckEntry[] {
  ...
  return [
    ...
    { id: 'X07059', name: '电源·资源降级', check: () => T.batteryMinutes(50, 10, 1) === 300 && T.batteryMinutes(50, -1, 1) === 0 },
    ...
    { id: 'X07063', name: '电源·键盘序', check: () => (T.POWER_PLANS as string[]).includes('custom') && new T.PowerManager('custom').profileId === 'custom' },
    { id: 'X07064', name: '电源·微文案', check: () => T.POWER_PLANS.every((x) => x.length > 0) },
    { id: 'X07065', name: '电源·aria 等价', check: () => T.batteryMinutes(100, 5, 1) === 1200 },
    ...
    { id: 'X07067', name: '电源·热路径', check: () => T.batteryMinutes(0, 10, 1) === 0 && T.batteryMinutes(100, 10, 1) === 600 },
...
export function checkF0284(): CheckEntry[] {
  ...
  return [
    ...
    { id: 'X07079', name: '外设·快照迁移', check: () => h.add('g1', 'gamepad', 20)!.batteryPct === 20 },
    { id: 'X07080', name: '外设·集成验证', check: () => h.countByKind('mouse') === 1 && h.remove('m1') && h.countByKind('mouse') === 0 },
    ...
    { id: 'X07094', name: '外设·低配减档', check: () => h.add('low', 'sd' as string) === null && h.clamped >= 2 },
...
export function checkF0288(): CheckEntry[] {
  ...
  return [
    ...
    { id: 'X07187', name: '传感·三态焦点', check: () => T.SensorFusion.poseFromAccel(0, 0, 9.8) === 'flat' && T.SensorFusion.poseFromAccel(3, 0, 9.8) === 'motion' },
