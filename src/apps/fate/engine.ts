...
function ageLabel(startAge: number, step: number, rng: () => number, lang: "zh" | "zh-TW" | "en"): string {
...
function chooseEnding(tone: number, rng: () => number, lang: "zh" | "zh-TW" | "en"): { type: string; text: string } {
...
export const catName = (cat: string, lang: "zh" | "zh-TW" | "en" = "zh"): string => {
