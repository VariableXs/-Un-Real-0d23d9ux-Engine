...
pub fn run_genstar2_checks() -> CheckSet {
    ...
    let blocks: [(&'static str, CheckSet); 50] = [
        ...
        ("F453", { let a = thumbbadge::run_thumbbadge_checks(); let b = thumbbadge::run_thumbbadge_deep_checks(); let c = thumbbadge::run_thumbbadge_v7_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ("F454", { let a = foldtmpl::run_foldtmpl_checks(); let b = foldtmpl::run_foldtmpl_deep_checks(); CheckSet::merge(a, b) }),
        ("F455", { let a = deskicons::run_deskicons_checks(); let b = deskicons::run_deskicons_deep_checks(); let c = deskicons::run_deskicons_v7_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ("F456", { let a = pcpage::run_pcpage_checks(); let b = pcpage::run_pcpage_deep_checks(); let c = pcpage::run_pcpage_v7_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ("F457", { let a = searchmath::run_searchmath_checks(); let c = searchmath::run_searchmath_v3_checks(); CheckSet::merge(a, c) }),
        ("F458", { let a = unitconv::run_unitconv_checks(); let b = unitconv::run_unitconv_deep_checks(); let c = unitconv::run_unitconv_v3_checks(); let d = unitconv::run_unitconv_v7_checks(); CheckSet::merge(CheckSet::merge(CheckSet::merge(a, b), c), d) }),
        ...
        ("F462", { let a = setwall::run_setwall_checks(); let b = setwall::run_setwall_deep_checks(); let c = setwall::run_setwall_v3_checks(); let d = setwall::run_setwall_v7_checks(); CheckSet::merge(CheckSet::merge(CheckSet::merge(a, b), c), d) }),
        ...
        ("F465", { let a = termalias::run_termalias_checks(); let b = termalias::run_termalias_deep_checks(); let c = termalias::run_termalias_v7_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ...
        ("F469", { let a = termcolor::run_termcolor_checks(); let d = termcolor::run_termcolor_v4_checks(); let e = termcolor::run_termcolor_v7_checks(); CheckSet::merge(CheckSet::merge(a, d), e) }),
        ...
        ("F472", { let a = termtheme::run_termtheme_checks(); let b = termtheme::run_termtheme_deep_checks(); let c = termtheme::run_termtheme_v6_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ("F473", { let a = setkbd::run_setkbd_checks(); let b = setkbd::run_setkbd_deep_checks(); let c = setkbd::run_setkbd_v7_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ("F474", { let a = setdesc::run_setdesc_checks(); let b = setdesc::run_setdesc_deep_checks(); let c = setdesc::run_setdesc_v5_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ("F475", { let a = idiffreg::run_idiffreg_checks(); let b = idiffreg::run_idiffreg_deep_checks(); let c = idiffreg::run_idiffreg_v5_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ...
        ("F478", { let a = avatar::run_avatar_checks(); let b = avatar::run_avatar_deep_checks(); let c = avatar::run_avatar_v5_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ("F479", { let a = hostname::run_hostname_checks(); let b = hostname::run_hostname_deep_checks(); let c = hostname::run_hostname_v5_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ...
        ("F481", { let a = touchpad::run_touchpad_checks(); let b = touchpad::run_touchpad_deep_checks(); let c = touchpad::run_touchpad_v5_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ("F482", { let a = swapbtn::run_swapbtn_checks(); let b = swapbtn::run_swapbtn_deep_checks(); let c = swapbtn::run_swapbtn_v5_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ("F483", { let a = wheeldir::run_wheeldir_checks(); let b = wheeldir::run_wheeldir_deep_checks(); let c = wheeldir::run_wheeldir_v5_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ...
        ("F487", { let a = privacysweep::run_privacysweep_checks(); let b = privacysweep::run_privacysweep_deep_checks(); let c = privacysweep::run_privacysweep_v5_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ("F488", { let a = appdata::run_appdata_checks(); let b = appdata::run_appdata_deep_checks(); let c = appdata::run_appdata_v6_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ("F489", { let a = shutbadge::run_shutbadge_checks(); let b = shutbadge::run_shutbadge_deep_checks(); let c = shutbadge::run_shutbadge_v5_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ("F490", { let a = shutblock::run_shutblock_checks(); let b = shutblock::run_shutblock_deep_checks(); let c = shutblock::run_shutblock_v5_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ("F491", { let a = autolum::run_autolum_checks(); let b = autolum::run_autolum_deep_checks(); let c = autolum::run_autolum_v3_checks(); let d = autolum::run_autolum_v7_checks(); CheckSet::merge(CheckSet::merge(CheckSet::merge(a, b), c), d) }),
        ("F492", { let a = powplan::run_powplan_checks(); let c = powplan::run_powplan_v3_checks(); CheckSet::merge(a, c) }),
        ("F493", { let a = coolgov::run_coolgov_checks(); let b = coolgov::run_coolgov_deep_checks(); let c = coolgov::run_coolgov_v6_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ("F494", { let a = taskautohide::run_taskautohide_checks(); let b = taskautohide::run_taskautohide_deep_checks(); let c = taskautohide::run_taskautohide_v5_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ("F495", { let a = taskoverflow::run_taskoverflow_checks(); let b = taskoverflow::run_taskoverflow_deep_checks(); let c = taskoverflow::run_taskoverflow_v7_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ("F496", { let a = tilelongpress::run_tilelongpress_checks(); let b = tilelongpress::run_tilelongpress_deep_checks(); let c = tilelongpress::run_tilelongpress_v5_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ("F497", { let a = ncactrow::run_ncactrow_checks(); let b = ncactrow::run_ncactrow_deep_checks(); let c = ncactrow::run_ncactrow_v5_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
        ...
        ("F499", { let a = lockwall::run_lockwall_checks(); let b = lockwall::run_lockwall_deep_checks(); let c = lockwall::run_lockwall_v3_checks(); let d = lockwall::run_lockwall_v7_checks(); CheckSet::merge(CheckSet::merge(CheckSet::merge(a, b), c), d) }),
        ("F500", { let a = xmovkey::run_xmovkey_checks(); let b = xmovkey::run_xmovkey_deep_checks(); let c = xmovkey::run_xmovkey_v7_checks(); CheckSet::merge(CheckSet::merge(a, b), c) }),
    ];
