...
pub fn run_dblrun_checks() -> CheckSet {
    CheckSet::merge(run_dblrun_base_checks(), CheckSet::merge(run_dblrun_deep_checks(), CheckSet::merge(run_dblrun_deep2_checks(), CheckSet::merge(run_dblrun_deep3_checks(), CheckSet::merge(run_dblrun_deep4_checks(), CheckSet::merge(run_dblrun_deep5_checks(), run_dblrun_deep6_checks()))))))
}
