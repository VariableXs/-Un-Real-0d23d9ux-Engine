...
pub fn run_clipfmt_checks() -> CheckSet {
    CheckSet::merge(run_clipfmt_base_checks(), CheckSet::merge(run_clipfmt_deep_checks(), CheckSet::merge(run_clipfmt_deep2_checks(), CheckSet::merge(run_clipfmt_deep3_checks(), CheckSet::merge(run_clipfmt_deep4_checks(), CheckSet::merge(run_clipfmt_deep5_checks(), run_clipfmt_deep6_checks()))))))
}
