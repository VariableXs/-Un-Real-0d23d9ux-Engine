...
pub fn run_pebind_checks() -> CheckSet {
    CheckSet::merge(run_pebind_base_checks(), CheckSet::merge(run_pebind_deep_checks(), CheckSet::merge(run_pebind_deep2_checks(), CheckSet::merge(run_pebind_deep3_checks(), CheckSet::merge(run_pebind_deep4_checks(), CheckSet::merge(run_pebind_deep5_checks(), run_pebind_deep7_checks()))))))
}
