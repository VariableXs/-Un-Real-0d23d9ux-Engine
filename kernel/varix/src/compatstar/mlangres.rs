...
pub fn run_mlangres_checks() -> CheckSet {
    CheckSet::merge(run_mlangres_base_checks(), CheckSet::merge(run_mlangres_deep_checks(), CheckSet::merge(run_mlangres_deep2_checks(), CheckSet::merge(run_mlangres_deep3_checks(), CheckSet::merge(run_mlangres_deep4_checks(), run_mlangres_deep5_checks())))))
}
