...
pub fn run_fontchain_checks() -> CheckSet {
    CheckSet::merge(run_fontchain_base_checks(), CheckSet::merge(run_fontchain_deep_checks(), CheckSet::merge(run_fontchain_deep2_checks(), CheckSet::merge(run_fontchain_deep3_checks(), CheckSet::merge(run_fontchain_deep4_checks(), run_fontchain_deep5_checks())))))
}
