...
pub fn run_comdlg_checks() -> CheckSet {
    CheckSet::merge(run_comdlg_base_checks(), CheckSet::merge(run_comdlg_deep_checks(), CheckSet::merge(run_comdlg_deep2_checks(), CheckSet::merge(run_comdlg_deep3_checks(), CheckSet::merge(run_comdlg_deep4_checks(), CheckSet::merge(run_comdlg_deep5_checks(), CheckSet::merge(run_comdlg_deep6_checks(), CheckSet::merge(run_comdlg_deep7_checks(), run_comdlg_deep8_checks()))))))))
}
...
pub fn run_comdlg_deep6_checks() -> CheckSet {
    ...
    cs.add(
        ...
        count == Some(3) && ends_double_nul, // 首段 = 目录（Windows 多选语义）
        "",
    );
