...
pub fn run_envsess_checks() -> CheckSet {
    CheckSet::merge(run_envsess_base_checks(), CheckSet::merge(run_envsess_deep_checks(), CheckSet::merge(run_envsess_deep2_checks(), CheckSet::merge(run_envsess_deep3_checks(), CheckSet::merge(run_envsess_deep4_checks(), run_envsess_deep5_checks())))))
}
