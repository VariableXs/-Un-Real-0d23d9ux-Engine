...
pub fn run_reghive_checks() -> CheckSet {
    CheckSet::merge(run_reghive_base_checks(), CheckSet::merge(run_reghive_deep_checks(), CheckSet::merge(run_reghive_deep2_checks(), CheckSet::merge(run_reghive_deep3_checks(), CheckSet::merge(run_reghive_deep4_checks(), run_reghive_deep5_checks())))))
}
