...
pub fn run_secstar2_checks() -> CheckSet {
    ...
    let blocks: [(&'static str, CheckSet); 15] = [
        ("F186", syspart::run_syspart_checks()),
        ("F187", clockguard::run_clockguard_checks()),
        ("F188", logring::run_logring_checks()),
        ("F189", selfheal2::run_selfheal2_checks()),
        ("F190", slotview::run_slotview_checks()),
        ("F191", bootaudit::run_bootaudit_checks()),
        ("F192", paramwl::run_paramwl_checks()),
        ("F193", safemode::run_safemode_checks()),
        ("F194", auditchain::run_auditchain_checks()),
        ("F195", resquota::run_resquota_checks()),
        ("F196", batguard::run_batguard_checks()),
        ("F197", thermgov::run_thermgov_checks()),
        ("F198", recenv::run_recenv_checks()),
        ("F199", lineage::run_lineage_checks()),
        ("F200", walkall::run_walkall_checks()),
    ];
