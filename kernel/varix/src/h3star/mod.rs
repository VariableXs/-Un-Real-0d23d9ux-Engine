...
pub fn h3star_blocks() -> Vec<(&'static str, CheckSet)> {
    vec![
        ...
        ("F332", merge_sets(merge_sets(merge_sets(merge_sets(merge_sets(merge_sets(animdegrade::run_fpsadapt_checks(), animdegrade::run_animdegrade_deep3_checks()), animdegrade::run_animdegrade_deep4_checks()), animdegrade::run_animdegrade_deep5_checks()), animdegrade::run_animdegrade_deep6_checks()), animdegrade::run_animdegrade_deep7_checks()), animdegrade::run_animdegrade_deep8_checks())),
        ...
        ("F337", merge_sets(merge_sets(merge_sets(merge_sets(merge_sets(merge_sets(merge_sets(merge_sets(copypath::run_cmdbg_checks(), copypath::run_cmdbg_deep2_checks()), copypath::run_copypath_deep3_checks()), copypath::run_copypath_deep4_checks()), copypath::run_copypath_deep5_checks()), copypath::run_copypath_deep6_checks()), copypath::run_copypath_deep7_checks()), copypath::run_copypath_deep8_checks()), copypath::run_copypath_deep9_checks())),
        ...
        ("F344", merge_sets(merge_sets(merge_sets(merge_sets(merge_sets(merge_sets(merge_sets(sysgov::run_appuninst_checks(), sysgov::run_sysgov_deep3_checks()), sysgov::run_sysgov_deep4_checks()), sysgov::run_sysgov_deep5_checks()), sysgov::run_sysgov_deep6_checks()), sysgov::run_sysgov_deep7_checks()), sysgov::run_sysgov_deep8_checks()), sysgov::run_sysgov_deep9_checks())),
