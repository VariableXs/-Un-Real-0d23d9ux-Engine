...
pub fn run_h3star_checks() -> CheckSet {
    ...
    let blocks: [(&'static str, CheckSet); 51] = [
        ...
        ("F321", nearshare::run_nearshare_checks()),
        ...
        ("F331", animdegrade::run_animdegrade_checks()),
        ...
        ("F336", copypath::run_copypath_checks()),
        ("F337", copypath::run_cmdbg_checks()),
        ("F338", multibar::run_multibar_checks()),
        ("F339", multibar::run_quicklook_checks()),
        ("F340", multibar::run_prevunify_checks()),
        ("F341", sndmode::run_sndmode_checks()),
        ("F342", sysgov::run_diskchk_checks()),
