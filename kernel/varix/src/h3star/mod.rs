...
pub fn h3star_blocks() -> Vec<(&'static str, CheckSet)> {
    vec![
        ...
        ("F337", merge_sets(merge_sets(merge_sets(copypath::run_cmdbg_checks(), copypath::run_cmdbg_deep2_checks()), copypath::run_copypath_deep3_checks()), copypath::run_copypath_deep4_checks())),
        ...
        ("F344", merge_sets(merge_sets(sysgov::run_appuninst_checks(), sysgov::run_sysgov_deep3_checks()), sysgov::run_sysgov_deep4_checks())),
